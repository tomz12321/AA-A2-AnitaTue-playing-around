...
public class ProbabilisticGuessPlayer extends Guesser implements Player{
    ...
    public void initialisePlayer(World world) {
        ...
        this.airCraftGuesser = new AirCraftGuesser();
        this.cruiserGuesser = new CruiserGuesser();
        this.frigateGuesser = new FrigateGuesser();
        frigateGuesser.initialGuesserMap(world);
        this.submarineGuesser = new SubmarineGuesser();
        this.patrolCraftGuesser = new PatrolCraftGuesser();
